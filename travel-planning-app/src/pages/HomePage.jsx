    ...
    return (
        ...
        <div className="relative isolate px-6 pt-14 lg:px-8">
            ...
            <div
                ...
                background: `linear-gradient(to top right, #00AFB9, #F07167)`,
                }}
            ...
            <div className="hidden sm:mb-8 sm:flex sm:justify-center">
                <div className="relative rounded-full px-3 py-1 text-sm leading-6 ring-1 hover:ring-opacity-80 transition-all" style={{ color: '#0081A7', backgroundColor: '#FED9B7', borderColor: '#00AFB9' }}>
                Powered by AI and Weather Forecasting.
                </div>
            </div>
            <div className="text-center">
                <h1 className="text-4xl font-bold tracking-tight sm:text-6xl" style={{ color: '#0081A7' }}>
                Create Perfect Travel Itineraries
                </h1>
                <p className="mt-6 text-lg leading-8" style={{ color: '#F07167' }}>
                Combine weather forecasts with AI-powered recommendations to plan unforgettable trips for your clients.
                </p>
